...
$common->checkUserVal();
?>
<div style="width: 100%;height: 80px;font-size: 60px;background-color: #0099CC;text-align: center">添加改错题界面
...
<form method="post" action="addprocess.php">
    ...
    改错题的问题 ：<textarea cols="30" rows="10" name="correct_name"></textarea><br/>
    需要改错的代码：<textarea cols="40" rows="5" name="correct_code"></textarea><span style="color: #ff0000">此项是显示需要改动的代码,可不填</span><br/>
    正确的代码：<textarea cols="40" rows="5" name="true_code"></textarea><br/>
    运行的答案：<textarea cols="40" rows="5" name="run_answer"></textarea><br/>
    <input type="hidden" name="form_class" value="correct" />
